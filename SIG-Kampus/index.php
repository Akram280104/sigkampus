    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">SIGKAMPUS </a>
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="index.php"><i class="fa fa-dashboard fa-2x"></i> MAPS</a>
                    </li>
...
<li>
    <a href="#"><i class="fa fa-laptop fa-2x"></i> Data Kampus<span class="fa arrow"></span></a>
    <ul class="nav nav-second-level">
        <li><a href="?page=kampus">Input Data</a></li>
    </ul>
</li>
                ...
                <div class="row">
                    <div class="col-md-12">
                     	...
                     	<?php
                     		...
                     		if ($page == "kampus" ) {
                                if ($aksi == "") {
                                    include "page/kampus/kampus.php";
                                }elseif ($aksi == "tambah") {
                                   include "page/kampus/tambah.php";
                               }elseif ($aksi == "ubah") {
                                   include "page/kampus/ubah.php";
                               }elseif ($aksi == "hapus") {
                                   include "page/kampus/hapus.php";
                               }elseif ($aksi== "cetak") {
                                   include "page/kampus/form_laporan_kampus.php";
                               }
                            }
                            elseif ($page == "lokasi" ) {
                                if ($aksi == "") {
